                ...
                <table class="table table-striped align-middle mb-0">
                    ...
                    <tbody>
                      ...
                      ?>
                            ...
                            <td>
                                <div><?= htmlspecialchars($guide['languages'] ?? '') ?></div>
                                <div><small class="text-muted"><?= (!empty($guide['experience_years']) ? (int)$guide['experience_years'] . ' năm' : '') ?></small></div>
                            </td>
                            <td><span
