...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="<?= BASE_URL ?>?r=suppliers"><i class="fas fa-handshake"></i> Nhà cung
                cấp</a>
                ...
                ?>
                            ...
                            <td>
                                <a class="btn btn-sm btn-outline-primary"
                                    href="<?= BASE_URL ?>?r=suppliers_show&id=<?= (int)$s['id'] ?>">Xem dịch vụ</a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr>
                            <td colspan="5" class="text-center py-4 text-muted">Chưa có nhà cung cấp</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
