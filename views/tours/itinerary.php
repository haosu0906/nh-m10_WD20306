    ...
    <?php foreach ($grouped as $day => $rows): ?>
      <div class="mb-4 timeline-day">
        ...
        <?php foreach ($rows as $r): ?>
          <div class="slot">
            <div class="slot-time">
              <?= htmlspecialchars(substr($r['activity_time'],0,5)) ?>
            ...
            <div class="flex-grow-1">
              ...
              <form method="post" action="<?= BASE_URL ?>?r=tours_itinerary_update" class="row g-2">
                ...
                <div class="col-md-2"><input type="time" class="form-control form-control-sm" name="activity_time" value="<?= htmlspecialchars(substr($r['activity_time'],0,5)) ?>"/></div>
