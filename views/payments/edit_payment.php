                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select form-select-lg" name="payment_method" required>
                                ...
                                <option value="momo" <?= $payment['payment_method'] === 'momo' ? 'selected' : '' ?>>MoMo</option>
                                <option value="zalopay" <?= $payment['payment_method'] === 'zalopay' ? 'selected' : '' ?>>ZaloPay</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select form-select-lg" name="status" required>
                                ...
                                <option value="refunded" <?= $payment['status'] === 'refunded' ? 'selected' : '' ?>>Đã hoàn</option>
                            </select>
                        </div>
                        <div class="col-12">
