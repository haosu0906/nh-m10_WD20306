                ...
                <table class="table table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $row['is_active'] ? '<span class="badge bg-success">Hoạt động</span>' : '<span class="badge bg-danger">Vô hiệu</span>' ?>
                            </td>
                            <td>
                                <a class="btn btn-sm btn-primary"
                                    href="<?= BASE_URL ?>?r=staff_edit&id=<?= $row['id'] ?>">Sửa</a>
                                <a class="btn btn-sm btn-danger"
                                    href="<?= BASE_URL ?>?r=staff_delete&id=<?= $row['id'] ?>"
