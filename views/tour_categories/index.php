...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="<?= BASE_URL ?>?r=tour_categories"><i class="fas fa-map"></i> Danh mục
                tour</a>
                ...
                ?>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary"
                                    href="<?= BASE_URL ?>?r=tour_categories_edit&id=<?= $row['id'] ?>">Sửa</a>
                                <a class="btn btn-sm btn-danger"
                                    href="<?= BASE_URL ?>?r=tour_categories_delete&id=<?= $row['id'] ?>"
