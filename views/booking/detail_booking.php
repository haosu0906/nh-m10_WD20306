        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form method="post" action="<?= BASE_URL ?>?r=booking_update_status">
                    ...
                    <button class="btn btn-primary mt-3" onclick="window.location.href='?r=booking'">Cập nhật</button>
                </form>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <?php
                    ...
                    if (!empty($guests)) {
                        foreach ($guests as $g) {
                            if (!empty(trim($g['special_notes'] ?? ''))) {
                                $specialList[] = trim($g['special_notes']);
                            }
                        }
                    }
                ?>
                ...
                <?php if (!empty($specialList)): ?>
                    <div class="alert alert-warning">Cảnh báo: Có yêu cầu đặc biệt từ khách. Nội dung: <?= htmlspecialchars(implode('; ', $specialList)) ?></div>
                <?php endif; ?>
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <?php foreach ($guests as $g): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($g['special_notes'] ?? $g['notes'] ?? '') ?></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
