...
<head>
    ...
    .sidebar { position: fixed; left: 0; top: 0; bottom: 0; width: 200px; padding: 20px;
               background: linear-gradient(180deg, var(--accent), #764ba2); color:#fff; overflow:auto; }
    .sidebar h3 { font-weight:700; margin-bottom:1rem; text-align:center; font-size:16px; }
    .nav-link { color: rgba(255,255,255,.95); display:flex; align-items:center; gap:.6rem; padding:.6rem;
        ...
        <div class="card mb-4">
            ...
            <div class="card-body row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" min="1" class="form-control" name="total_guests" id="total-guests" value="1" required />
                </div>
                <div class="col-md-3">
        ...
        <div class="card">
            ...
            <div class="card-body" id="guests-container">
                <div class="row g-2 guest-row mb-3">
                    <div class="col-md-3">
                        <input type="text" name="guest_full_name[]" class="form-control" placeholder="Họ tên" required />
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="guest_id_document_no[]" class="form-control" placeholder="CMND/CCCD" />
                    </div>
                    <div class="col-md-2 d-flex gap-2">
                        <input type="text" name="guest_special_notes[]" class="form-control" placeholder="Ghi chú đặc biệt" />
...
if (form) {
    form.addEventListener('submit', function(e) {
        ...
        if (names.length !== total) {
            if (!confirm('Số lượng khách nhập (' + names.length + ') khác với tổng số khách (' + total + '). Bạn vẫn muốn tiếp tục?')) {
                e.preventDefault();
                return;
            }
        }
