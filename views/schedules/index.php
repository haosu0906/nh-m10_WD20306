                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary"
                                    href="<?= BASE_URL ?>?r=schedules_edit&id=<?= (int)$row['id'] ?>">Sửa</a>
                                <a class="btn btn-sm btn-danger"
                                    href="<?= BASE_URL ?>?r=schedules_delete&id=<?= (int)$row['id'] ?> onclick=" return
                                    confirm('Xóa lịch này?')">Xóa</a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr>
                            <td colspan="5" class="text-center py-4 text-muted">Chưa có lịch</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
